...
Proiectul cuprinde planificarea, organizarea și urmărirea lucrărilor de amenajare, cu scopul de a transforma proprietatea într-un spațiu funcțional și estetic.
...
| Pagină | Descriere |
|---|---|
| [🌿 Time-lapse Grădină](https://schmicky.github.io/crucea/time-lapse/plan-amenajare.html) | Aplicația principală: planul grădinii cu cele ~290 de plante, animație fenologică pe luni (repaus / vegetație / înflorire / fructificare), mod de editare a pozițiilor, mod de măsurare — distanțe, arii, azimut, calibrare, import/export de zone — și mod de suprapunere, care așază plantele georeferențiate peste imaginea satelitară a terenului. La click pe o plantă se deschide fișa speciei: fotografie și rezumat de pe Wikipedia, înălțimea estimată la 2 ani, la 5 ani și la maturitate, cerința de lumină, dozele de udare din primii doi ani, calendarul fenologic și linkuri către Wikipedia engleză și română |
| [🧭 Plan amenajare — nord sus](https://schmicky.github.io/crucea/time-lapse/plan-amenajare-nord.html) | Aceeași aplicație, cu planșa și toate plantele rotite ca nordul să fie în sus. Varianta de lucru pentru perdeaua de vânt: gardul de ulm scos de pe latura de sud, arbuștii de pe nord mutați 5 m spre interior și rândurile noi de ulm și sălcioară pe latura de nord (325 de puncte). Are date proprii — `pozitie-nord.json`, `masuratori-nord.json` |
| [🌱 Plan nou de vegetație](https://schmicky.github.io/crucea/time-lapse/plan-amenajare-nou.html) | Vegetația refăcută de la zero, cu toate construcțiile, aleile, iazul, cotețul și parcarea pe poziție: perdele de vânt pe nord și est, gard comestibil jos pe sud, labirint de arbuști cu fructe, livada căsuțelor, borduri de stepă la iaz, pajiște semănată în loc de gazon — 610 plante din 81 de specii, 11 zone conturate, planșă curățată de vegetația veche. Date proprii: `pozitie-nou.json`, `zone-nou.json`, `plan-nou.jpg` |
...
Conceptul planului nou de vegetație — zone, specii noi/scoase/păstrate cu argumente, lumină, vânt, biodiversitate, întreținere pe ani, plantare ieftină: [plan-nou-concept.md](https://github.com/schmicky/crucea/blob/master/time-lapse/plan-nou-concept.md) · planul desenat: [plan-nou-randare.png](https://github.com/schmicky/crucea/blob/master/time-lapse/plan-nou-randare.png).
...
- Gestionarea resurselor și a bugetului
...
├── planuri/           # Planuri și schițe de amenajare
├── documente/         # Acte, autorizații, contracte
├── fotografii/        # Documentație foto a lucrărilor
└── buget/             # Evidența cheltuielilor
```
...
Pentru informații suplimentare legate de acest proiect, luați legătura cu responsabilul de proiect.
